...
const MultiStepForm = React.forwardRef<HTMLDivElement, MultiStepFormProps>(
  ({
    ...
    return (
      <Card ref={ref} className={cn(multiStepFormVariants({ size }), "border-2 border-indigo-100 dark:border-indigo-900/50 shadow-xl shadow-indigo-500/5 bg-white dark:bg-gray-900", className)} {...props}>
        <CardHeader>
